...
int main(int argc, char *argv[])
{
    ...
    cout<<endl;
    cout<<"Masukkan banyak pesanan : ";cin>>banyak_pesanan;
    cout<<endl<<"Status Pesanan"<<endl;
    cout<<"---------------------------------"<<endl;
    cout<<"1. Makan Ditempat"<<endl;
    cout<<"2. Dibungkus"<<endl;
    cout<<"---------------------------------"<<endl;
    cout<<"Masukkan status pesanan : ";cin>>status_pesanan;
    system("cls");
    //proses
    //if model ke-1
    if((menu==1)&&(porsi==1))
    ...
    cout<<"----------------------------------------------"<<endl;
    cout<<"Diskon            : Rp. "<<setprecision(2)<<setw(10)<<diskon<<endl;
    cout<<"Total harga       : Rp. "<<setprecision(2)<<setw(10)<<total_harga_awal<<endl;
    cout<<"Pajak             : Rp. "<<setprecision(2)<<setw(10)<<pajak<<endl;
    cout<<"Bayar             : Rp. "<<setprecision(2)<<setw(10)<<total_harga_akhir<<endl;
    cout<<"----------------------------------------------"<<endl;
    system("PAUSE");
    return EXIT_SUCCESS;
}
