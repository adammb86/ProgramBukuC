...
int main(int argc, char *argv[])
{
  ...
  printf("Tanggal lahir   : ");scanf("%i",&dosen.tanggal_lahir.tanggal);
  printf("Bulan lahir     : ");scanf("%i",&dosen.tanggal_lahir.bulan);
  printf("Tahun lahir     : ");scanf("%i",&dosen.tanggal_lahir.tahun);
  printf("\n\n");
  printf("NIP    		= %li\n",dosen.nip);
  printf("Nama   		= %s\n",dosen.nama);
  printf("Alamat 		= %s\n",dosen.alamat);
