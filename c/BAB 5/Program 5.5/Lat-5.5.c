...
int main(int argc, char *argv[])
{
  ...
  printf("3. Puyung Hay\n");
  printf("---------------------------------\n");
  printf("Masukkan pilihan makanan : ");scanf("%i",&menu);
  printf("\n");
  ...
  printf("3. Besar\n");
  printf("---------------------------------\n");
  printf("Masukkan pilihan porsi  : ");scanf("%i",&porsi);
  printf("\n");
  printf("Masukkan banyak pesanan : ");scanf("%i",&banyak_pesanan);
  printf("\nStatus Pesanan\n");
  printf("---------------------------------\n");
  printf("1. Makan Ditempat\n");
  printf("2. Dibungkus\n");
  printf("---------------------------------\n");
  printf("Masukkan status pesanan : ");scanf("%i",&status_pesanan);
  system("cls");
  //proses
  //if model ke-1
  if((menu==1)&&(porsi==1))
